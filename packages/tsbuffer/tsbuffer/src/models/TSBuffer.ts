...
export class TSBuffer<Proto extends TSBufferProto = TSBufferProto> {
    ...
    private readonly _validator: TSBufferValidator<Proto>
    private _encoder: Encoder
    private _decoder: Decoder
    private readonly _proto: Proto
    /** @internal 默认配置 */
    private readonly _options: TSBufferOptions = {
    ...
    constructor(proto: Proto, options?: Partial<TSBufferOptions>) {
        ...
        this._proto = this._options.cloneProto ? merge({}, proto) : proto
        Object.assign(this._proto, merge({}, options?.customTypes))
